...
# Note, the script was run on Beartooth as "step4_Biomass_fit_model_pt2.R" due
# to filename protocol.

# This script fits the latent biomass model to the second set of sites (the
...
## Source data
df <- readRDS("list_181sites_Qmaxnorm_SavoySL_pt2.rds")
...
saveRDS(PM_outputlist_Ricker, "/project/modelscape/users/hlowman/jobresults/beartooth_spring23/beartooth_181rivers_output_pt2_2023_05_05.rds")
