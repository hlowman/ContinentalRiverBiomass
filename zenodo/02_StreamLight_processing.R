...
# Links to the raw data sets are provided here and in the 01_NWIS_RiverSelection.R file.
...
# This script pairs eligible sites with available stream surface light data.
