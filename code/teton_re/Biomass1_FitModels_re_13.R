...
# This is the script sent today to try the newer formulation of parameters,
...
PM_outputlist_Ricker_test <- stan("/project/modelscape/users/hlowman/jobscripts/teton_re/Stan_ProductivityModel2_Ricker_fixedinit_obserr_ts_wP_re2_newNEWpriors_nopredGPP.stan",
                                  data = stan_data_l,
                                  chains = 3,
                                  iter = 5000,
                                  init = init_Ricker,
...
# export data
saveRDS(PM_outputlist_Ricker_test, "/project/modelscape/users/hlowman/jobresults/teton_re/stan_10rivers_output_Ricker_re2_2022_07_07.rds")
