...
*H~2~*: The maximum growth rate will be greatest immediately following **disturbance** events that scour existing biomass. Carrying capacity will be altered if the **disturbance** is of large enough scale to alter the physical structure of the stream (e.g., could decrease due to infill with sediment or increase due to increase in surface area).
