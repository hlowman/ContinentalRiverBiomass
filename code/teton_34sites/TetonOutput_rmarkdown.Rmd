...
```{r map, fig.align = "center", fig.cap = "Fig. 1. Summary statistics of (A) stream order and (B) years of data above (C) a map of the United States with locations of all stream sites included in the dataset.", out.width = "50%", echo = FALSE}
...
Figures of all available covariates (by site-year) as well as the full set of our model diagnostics are available to view on a separate R Shiny application located HERE. Below are a few overview figures examining initial relationships between model parameter values and stream order.
