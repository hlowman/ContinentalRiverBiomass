...
## Step TWO in Metabolism Modeling Workflow
## November 16, 2021
## Heili Lowman
...
NWIS_pooling_3sites_subset <- readRDS("data_working/NWIS_pooling_3sites_subset.rds")
NWIS_pooling_3sitesinfo_subset <- readRDS("data_working/NWIS_pooling_3sitesinfo_subset.rds")
NWIS_pooling_3sites_Ndays <- readRDS("data_working/NWIS_pooling_3sites_Ndays.rds")

## Site of interest that has StreamLight data
sites <- NWIS_pooling_3sitesinfo_subset$site_name
...
# NO STREAM LIGHT DATA AT THESE SITES SO STOPPED HERE.
...
# ## Save
# 
# saveRDS(site_subset, "data_working/StreamLight_daily_pooling_3sites.rds")
# 
# # End of script.
