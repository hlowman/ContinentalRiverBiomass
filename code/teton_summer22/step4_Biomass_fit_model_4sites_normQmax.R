...
## Source data
df <- readRDS("/project/modelscape/users/hlowman/jobscripts/teton_summer22/list_4sites_meanmaxQnorm_allSL.rds")
...
saveRDS(PM_outputlist_Ricker, "/project/modelscape/users/hlowman/jobresults/teton_summer22/teton_4rivers_output_2022_09_08.rds")
