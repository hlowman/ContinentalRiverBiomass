...
## Source data
df <- readRDS("/project/modelscape/users/hlowman/jobscripts/teton_summer22/list_190sites_10yrQnorm_allSL_pt2.rds")
...
saveRDS(PM_outputlist_Ricker, "/project/modelscape/users/hlowman/jobresults/teton_summer22/teton_190rivers_output_pt2_2022_07_29.rds")
