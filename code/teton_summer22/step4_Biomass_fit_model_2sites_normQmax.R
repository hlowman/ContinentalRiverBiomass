...
## Source data
df <- readRDS("/project/modelscape/users/hlowman/jobscripts/teton_summer22/list_2sites_meanmaxQnorm_allSL.rds")
...
stan_data_compile <- function(x){
  data <- list(Ndays=length(x$GPP), # number of days/records
               ...
               tQ = x$Q_rel_max,    # relativized discharge (to max Q)
...
saveRDS(PM_outputlist_Ricker, "/project/modelscape/users/hlowman/jobresults/teton_summer22/teton_2rivers_output_2022_09_12.rds")
