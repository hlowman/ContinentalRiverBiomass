...
**We are interested in learning about streams' responses to disturbance (i.e., storm events). Specifically, we are fitting a logistic population growth model to gross primary production estimates so that we can gain information about growth parameters (e.g., maximum growth rate, critical disturbance thresholds) that describe algal population dynamics and compare results across stream sites.**
...
```{r results1, fig.align = "center", fig.cap = "Figure 4. Plots of mean maximum growth rates as (A) an overall distribution across all sites and (B) versus the coefficient of variation in discharge.", out.width = "100%", echo = FALSE}

knitr::include_graphics(here::here("figures", "teton_fall22", "r_cvQ.jpg"))
