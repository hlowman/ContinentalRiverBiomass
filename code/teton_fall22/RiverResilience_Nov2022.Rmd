...
```{r fig3, fig.align = "left", fig.cap = "Figure 3. Plots of median maximum growth rates versus (A) mean daily gross primary production (GPP), (B) the coefficient of variation in discharge (CV~Q~), (C) daily mean light availability, (D) cumulative summer light availability, (E) mean daily summer water temperature, (F) stream width, (G) catchment size, (H) relative influence of dams (0 value indicating certain influence of a given structure), (I) road density in the catchment (km/km^2), (J) percent impervious land cover in the catchment, (K) mean nitrate concentrations (mg/L NO~3~-N), and (L) mean orthophosphate concentrations (mg/L PO~4~-P).", out.width = "100%", echo = FALSE}

knitr::include_graphics(here::here("figures", "teton_fall22", "rmax_12panel_nov.jpg"))
