...
Figures of all available covariates (discharge, temperature, light) as well as the full suite of model diagnostics are available to view on a separate R Shiny application located [here](https://hlowman.shinyapps.io/shiny/). Below are a few overview figures examining initial relationships among model parameter values and site covariates.
