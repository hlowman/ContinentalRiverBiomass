...
# to fit the new and improved Ricker model to a test dataset (4 sites).
...
sitelist <- c("nwis_02266300", "nwis_03067510", "nwis_07191222", "nwis_04121944")

site_subset <- TS %>%
  filter(site_name %in% sitelist) # 4 sites
...
# not making these figures for the Teton test run
...
## NWIS site subset
saveRDS(site_subset, "data_working/NWIS_4sites_subset.rds") # GPP data
saveRDS(TS_site_subset, "data_working/NWIS_4sitesinfo_subset.rds") # Site data
saveRDS(site_subset_numdays,"data_working/NWIS_4sites_Ndays.rds") # Gaps in data
