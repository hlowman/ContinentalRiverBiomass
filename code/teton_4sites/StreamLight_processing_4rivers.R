...
NWIS_4sites_subset <- readRDS("data_working/NWIS_4sites_subset.rds")
NWIS_4sitesinfo_subset <- readRDS("data_working/NWIS_4sitesinfo_subset.rds")
NWIS_4sites_Ndays <- readRDS("data_working/NWIS_4sites_Ndays.rds")

## Site of interest that has StreamLight data
sites <- NWIS_4sitesinfo_subset$site_name
...
saveRDS(site_subset, "data_working/StreamLight_daily_4sites.rds")
