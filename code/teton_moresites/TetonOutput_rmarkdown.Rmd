...
**We are interested in learning about streams' responses to disturbance (i.e., storm events). Specifically, by fitting a logistic population growth model to gross primary production estimates, we can gain information about growth parameters (e.g., maximum growth rate). We then aim to compare these population parameters describing algal biomass in streams across different sites and conditions to learn about these streams' resilience following disturbance.**
