...
```{r results1, fig.align = "center", fig.cap = "Figure 6. Plot of mean maximum growth rates (r) and the log of mean carrying capacities (K) for individual sites. Note 14 sites with negative mean r and K values have been removed.", out.width = "50%", echo = FALSE}

knitr::include_graphics(here::here("figures", "teton_moresites", "r_K_allsites.jpg"))

```

```{r results2, fig.align = "center", fig.cap = "Figure 7. Boxplots of (A) mean maximum growth rates (r) and (B) mean carrying capacities (K) for individual sites grouped by stream order. Note, the same 14 sites that were removed from Figure 6 have been removed from these panels.", echo = FALSE}
